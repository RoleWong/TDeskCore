...
@class TDeskTheme;
@class TDeskThemeManager;

NS_ASSUME_NONNULL_BEGIN

#define TDeskShareThemeManager TDeskThemeManager.shareManager
 ...
 */
#define TDeskRegisterThemeResourcePath(path, module) [TDeskShareThemeManager registerThemeResourcePath:path forModule:module];

/**
 * Get the theme used by the module
 */
#define TUICurrentTheme(module) [TDeskShareThemeManager currentThemeForModule:module]

/**
 * Get the dark night theme of the module
 */
#define TUIDarkTheme(module) [TDeskShareThemeManager darkThemeForModule:module]
...
#define TUIDynamicImage(imageKey, themeModule, defaultImg) [TDeskTheme dynamicImage:imageKey module:themeModule defaultImage:defaultImg]
