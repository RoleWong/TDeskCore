 ...
 *
 * TDeskConfig implements the default initialization of the configuration file, you can change the default configuration here according to your needs
...
#define DefaultAvatarImage ([TDeskConfig defaultConfig].defaultAvatarImage)
#define DefaultGroupAvatarImage ([TDeskConfig defaultConfig].defaultGroupAvatarImage)
#define DefaultGroupAvatarImageByGroupType(groupType) ([[TDeskConfig defaultConfig] getGroupAvatarImageByGroupType:groupType])

typedef NS_ENUM(NSInteger, TDeskAvatarType) {
    TAvatarTypeNone,
    TAvatarTypeRounded,
    TAvatarTypeRadiusCorner,
};

@interface TDeskConfig : NSObject

+ (TDeskConfig *)defaultConfig;
/**
 *  Type of avatar
 */
@property(nonatomic, assign) TDeskAvatarType avatarType;
